...
const roles = [
    { icon: Users, key: 'trainee', color: '#ff7b00', en: { title: 'Trainee', desc: 'Track your workouts, diet, and gym memberships with AI-powered coaching.' }, ar: { title: 'متدرب', desc: 'تتبع تمارينك، نظامك الغذائي، وعضوياتك في الجيم بتدريب مدعوم بالذكاء الاصطناعي.' } },
    { icon: Dumbbell, key: 'trainer', color: '#ff8c00', en: { title: 'Personal Trainer', desc: 'Manage clients, assign programs, and grow your income through our ecosystem.' }, ar: { title: 'مدرب شخصي', desc: 'أدر عملاءك، خصص البرامج، ونمِّ دخلك من خلال منظومتنا.' } },
    { icon: Building2, key: 'gym', color: '#ffb300', en: { title: 'Gym / Branch', desc: 'Onboard members, manage attendance with QR codes, and track revenue in real time.' }, ar: { title: 'صالة رياضية', desc: 'استقطب الأعضاء، أدر الحضور برمز QR، وتتبع إيراداتك فورياً.' } },
...
export default function RegisterPage() {
    ...
    return (
        <div dir={isArabic ? 'rtl' : 'ltr'} className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden" style={{ backgroundColor: 'var(--bg-primary)' }}>
            <div className="absolute top-0 start-0 w-[500px] h-[500px] rounded-full blur-[200px] pointer-events-none opacity-20" style={{ background: 'radial-gradient(circle, #ff7b00, transparent)' }} />
            <div className="absolute bottom-0 end-0 w-[400px] h-[400px] rounded-full blur-[160px] pointer-events-none opacity-15" style={{ background: 'radial-gradient(circle, #ffb300, transparent)' }} />
            ...
            <p className="text-center mt-8 text-sm z-10" style={{ color: 'var(--text-secondary)' }}>
                ...
                <Link href="/login" className="font-bold hover:underline" style={{ color: '#ff7b00' }}>
