...
const RECIPES = [
    {
        ...
        descEn: '3 ingredients. 20g protein. 5 minutes.', descAr: '٣ مكونات. ٢٠ جرام بروتين. ٥ دقائق.',
        ...
        ingredientsAr: ['٢ موزة', '٢ بيضة', 'سكوب واي بروتين', '١ ملعقة قرفة'],
    ...
    },
    {
        ...
        ingredientsAr: ['١٥٠ جرام صدر دجاج', '٨٠ جرام أرز بني', 'بروكلي', 'زيت زيتون', 'بهارات'],
    ...
    },
    {
        ...
        descEn: '700 kcal protein shake for bulking.', descAr: 'شيك ٧٠٠ سعرة للزيادة في الكتلة.',
        ...
        ingredientsAr: ['٢ موزة', '٢٥٠مل حليب كامل', '٢ سكوب واي', '٢ ملعقة زبدة فستق', 'شوفان', 'عسل'],
        steps: ['Add all ingredients to blender', 'Blend for 60 seconds', 'Serve immediately'],
        stepsAr: ['ضع كل المكونات في الخلاط', 'اخلط لمدة ٦٠ ثانية', 'قدّمه فوراً'],
    ...
    },
    {
        ...
        ingredientsAr: ['٦ بياض بيض', 'سبانخ', 'فلفل ألوان', 'جبن قليل دسم', 'ملح وفلفل'],
        steps: ['Preheat oven to 180°C', 'Mix all ingredients', 'Pour into muffin tin', 'Bake 15 minutes'],
        stepsAr: ['سخّن الفرن ١٨٠°م', 'اخلط كل المكونات', 'صبّهم في قالب الكبكيك', 'اخبِزهم ١٥ دقيقة'],
        color: '#00B8FF', aiRecom: false
    },
    {
        id: 5, category: 'dinner', emoji: '🐟',
        nameEn: 'Salmon & Sweet Potato', nameAr: 'سلمون وبطاطا حلوة',
        descEn: 'Omega-3 rich dinner with complex carbs.', descAr: 'عشاء غني بالأوميجا ٣ مع كارب معقد.',
        kcal: 620, protein: 42, carbs: 55, fat: 22,
        prepMin: 10, cookMin: 25, servings: 1, difficulty: 'medium',
        rating: 4.9, reviews: 312,
        tags: ['Omega-3', 'Clean Eating'], tagsAr: ['أوميجا ٣', 'أكل نظيف'],
        ingredients: ['200g salmon fillet', '1 sweet potato', 'Asparagus', 'Lemon', 'Garlic', 'Olive oil'],
        ingredientsAr: ['٢٠٠ جرام فيليه سلمون', 'بطاطا حلوة', 'أسباراغوس', 'ليمون', 'ثوم', 'زيت زيتون'],
        ...
        stepsAr: ['اخبِز البطاطا ٢٠٠°م لمدة ٢٠ دقيقة', 'تبّل السلمون بليمون وثوم', 'اشوِه ٤ دقائق لكل وجه', 'قدّمه مع الأسباراغوس'],
        color: '#FF6B35', aiRecom: true
    },
    {
        id: 6, category: 'preworkout', emoji: '⚡',
        nameEn: 'Oat Energy Bars', nameAr: 'بارات شوفان طاقة',
        descEn: 'Make 8 bars in 10 mins. Lasts a whole week.', descAr: 'اعمل ٨ بارات في ١٠ دقائق. تكفي أسبوع.',
        ...
        ingredientsAr: ['٢ كوب شوفان', '٢ ملعقة عسل', '٣ ملعقة زبدة فستق', 'شيبس شوكولاتة داكنة', 'فانيليا'],
