            ...
            <div className="flex justify-between items-center mb-10">
                <div>
                    <h1 className="text-3xl font-bold tracking-tight text-white flex items-center gap-3">
                        <Package className="w-8 h-8 text-[#00B8FF]" /> Store Inventory
                    </h1>
                    <p className="text-gray-400 mt-2">Manage products, stock, and platform orders.</p>
                </div>
                <button className="bg-[#00B8FF] text-black font-bold px-5 py-2.5 rounded-xl hover:bg-[#0096FF] transition-colors flex items-center gap-2 shadow-[0_0_15px_rgba(0,184,255,0.4)]">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div className="lg:col-span-2 bg-[#141414]/80 backdrop-blur-xl border border-white/5 rounded-3xl overflow-hidden shadow-2xl">
                    <div className="p-6 border-b border-white/5 flex justify-between items-center bg-white/[0.02]">
                        ...
                        <input type="text" placeholder="Search SKU..." className="bg-black/50 border border-white/10 rounded-lg px-3 py-1.5 text-sm outline-none focus:border-[#00B8FF] transition-colors" />
                    </div>
                            ...
                            {[
                                ...
                                <tr key={idx} className="hover:bg-white/[0.02] transition-colors">
                                    ...
                                    <td className="px-6 py-4">
                                        <span className={`px-2.5 py-1 rounded-md font-mono text-xs ${product.alert ? 'bg-red-500/10 text-red-400 border border-red-500/20' : 'bg-[#00FFA3]/10 text-[#00FFA3] flex w-fit items-center gap-1'}`}>
                ...
                <div className="space-y-6">
                    <div className="bg-gradient-to-br from-[#141414] to-black border border-white/5 rounded-3xl p-6 relative overflow-hidden group">
                        <div className="absolute top-0 right-0 w-32 h-32 bg-[#00B8FF]/10 rounded-full blur-3xl -mr-10 -mt-10 transition-transform group-hover:scale-150" />

                        <h3 className="text-lg font-bold flex items-center gap-2 mb-6 text-white z-10 relative">
                            <ShoppingCart className="w-5 h-5 text-[#00B8FF]" /> Recent Orders
                        </h3>
                                    ...
                                    <div className="flex justify-between items-end mt-4">
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500 flex items-center gap-1 mt-1">
                                                <Percent className="w-3 h-3" /> Platform Cut: <span className="text-[#00B8FF] font-mono">-$12.44</span>
                                            </p>
                                        </div>
                                        <button className="text-sm text-[#00FFA3] hover:underline">Fulfill</button>
                                    </div>
                                </div>
                            ))}
                        </div>
