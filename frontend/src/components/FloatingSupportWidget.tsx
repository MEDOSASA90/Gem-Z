    ...
    return (
        <>
            <button
                ...
                className={`fixed bottom-6 ${isArabic ? 'left-6' : 'right-6'} z-50 bg-gradient-to-r from-[#00FFA3] to-[#00B8FF] text-black w-14 h-14 rounded-full flex items-center justify-center shadow-[0_0_20px_rgba(0,184,255,0.4)] hover:scale-110 transition-transform ${isOpen ? 'scale-0' : 'scale-100'}`}
            >
            ...
            <div className={`fixed bottom-24 ${isArabic ? 'left-6' : 'right-6'} z-50 w-80 bg-[#141414]/95 backdrop-blur-xl border border-white/10 rounded-2xl shadow-[0_10px_40px_rgba(0,0,0,0.8)] overflow-hidden flex flex-col transition-all duration-300 origin-bottom ${isOpen ? 'scale-100 opacity-100' : 'scale-0 opacity-0 pointer-events-none'}`}>
                <div className="bg-gradient-to-r from-[#00FFA3] to-[#00B8FF] p-4 flex justify-between items-center">
                ...
                <div className="p-3 border-t border-white/10 bg-[#141414] flex gap-2">
                    <input
                        ...
                        className="flex-1 bg-black/50 border border-white/10 rounded-xl px-4 py-2 text-sm text-white outline-none focus:border-[#00B8FF]/50 transition-colors"
                    />
                    <button className="bg-[#00B8FF]/20 text-[#00B8FF] p-2 rounded-xl hover:bg-[#00B8FF]/30 transition-colors">
