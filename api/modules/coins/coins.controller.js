...
class CoinsController {
    ...
    static async redeemReward(req, res) {
        ...
        try {
            ...
            const balRes = await client.query(`SELECT total_points FROM trainee_profiles WHERE user_id = $1 FOR UPDATE`, [userId]);
            ...
            const result = await client.query(`UPDATE trainee_profiles 
                 SET total_points = total_points - $1, updated_at = NOW()
                 WHERE user_id = $2 
    ...
    static async stakeCoinsForGoal(req, res) {
        ...
        try {
            ...
            await client.query(`UPDATE trainee_profiles SET total_points = total_points - $1, updated_at = NOW() WHERE user_id = $2`, [cost, userId]);
            await client.query('COMMIT');
