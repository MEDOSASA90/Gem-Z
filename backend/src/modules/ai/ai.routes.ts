...
import { generatePlan, getSavedPlans, analyzeForm, scanFood, adjustPlanDynamically, chatWithAI, logVoiceWorkout, renderCinematicWorkout, processBodyScan } from './ai.controller';
...
router.post('/body-scan', authenticate as any, processBodyScan as any);
